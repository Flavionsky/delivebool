                ...
                <div class="blocks flex-2">
                    ...
                    <div class="block comfort-food">
                        <div class="top-block-2">
                            ...
                            <p>Delivebool sta raccogliendo fondi per fornire cibo gratuito alle famiglie più in difficoltà,
                                attraverso la Croce Rossa Italiana (CRI). Puoi contribuire alla raccolta fondi facendo una
                                donazione qui.</p>
                        </div>
                    </div>
                    ...
                    <div class="block comfort-food">
                        <div class="top-block-2">
                            ...
                            <h2>Obicà</h2>
                            <p>Ordina la tua mozzarella preferita a casa tua da Obicà grazie alla consegna a domicilio di
                                Delivebool.</p>
                        </div>
                    </div>
                ...
                <div class="blocks flex-2">
                    ...
                    <div class="block comfort-food">
                        <div class="top-block-2">
                            ...
                            <h2>Lievità</h2>
                            <p>Ordina la tua pizza preferita a casa tua da Lievità grazie alla consegna a domicilio di
                                Delivebool.</p>
                        </div>
                    </div>
                    ...
                    <div class="block comfort-food">
                        <div class="top-block-2">
                            ...
                            <p>Ordina il tuo sushi preferito a casa tua da Daruma Sushi grazie alla consegna a domicilio di
                                Delivebool.</p>
                        </div>
                    </div>
                ...
                <div class="blocks flex-2">
                    ...
                    <div class="block comfort-food">
                        <div class="top-block-2">
                            ...
                            <h2>Temakinho</h2>
                            <p>Ordina il tuo sushi preferito a casa tua da Temakinho grazie alla consegna a domicilio di
                                Delivebool.</p>
                        </div>
                    </div>
                ...
                <div class="blocks flex-2">
                    ...
                    <div class="block comfort-food">
                        <div class="top-block-2">
                            ...
                            <h2>Macha</h2>
                            <p>Ordina i tuoi piatti preferiti della cucina giapponese a casa tua da Macha grazie alla
                                consegna a domicilio di Delivebool.</p>
                        </div>
                    </div>
                    ...
                    <div class="block comfort-food">
                        <div class="top-block-2">
                            ...
                            <h2>Grom</h2>
                            <p>Tutti i prodotti sono senza glutine. Sono realizzati senza aggiunta di aromi, coloranti o
                                emulsionanti e creati scegliendo solo il meglio della natura. Innamorati del nostro gelato e
                                gusta anche i nostri biscotti, le creme spalmabili e il nostro cioccolato</p>
            ...
            <div class="container text">
                ...
                <div class="blocks flex-2 ">
                    ...
                    <div class="box-work orange">
                        ...
                        <h2>Ristoranti</h2>
                        <p>Diventa partner di Delivebool e raggiungi sempre più clienti. Ci occupiamo noi della consegna,
                            così che la tua unica preoccupazione sia continuare a preparare il miglior cibo.</p>
                        <a href="{{ route('register') }}"><button type="button" name="button">Diventa nostro
                                partner</button></a>
                    </div>
                    ...
                    <div class="box-work grey">
                        ...
                        <p>La nostra missione è trasformare il modo in cui le persone mangiano. È un obiettivo ambizioso,
                            come noi, e ci servono persone che ci aiutino a raggiungerlo.</p>
